...
if __name__=="__main__":
    ...
    extraction_unitary(complete_data_json(ibm_fez), type="complete")
    extraction_unitary(complete_data_json(ibm_torino), type="complete")
    extraction_unitary(complete_data_json(ibm_marrakesh), type="complete")

    extraction_unitary(qub_data_json(ibm_fez), type="qubits")
    extraction_unitary(qub_data_json(ibm_torino), type="qubits")
    extraction_unitary(qub_data_json(ibm_marrakesh), type="qubits")

    extraction_unitary(gate_data_json(ibm_fez), type="gates")
    extraction_unitary(gate_data_json(ibm_torino), type="gates")
    extraction_unitary(gate_data_json(ibm_marrakesh), type="gates")